...
type Revocation interface {
	...
	Sign(key interface{}, unrevokedHandles [][]byte, epoch int, alg bccsp.RevocationAlgorithm) ([]byte, error)
	...
	Verify(pk interface{}, cri []byte, epoch int, alg bccsp.RevocationAlgorithm) error
}
...
type SignatureScheme interface {
	...
	Verify(ipk IssuerPublicKey, signature, msg []byte, attributes []bccsp.IdemixAttribute, rhIndex int, revocationPublicKey interface{}, epoch int) error
}
